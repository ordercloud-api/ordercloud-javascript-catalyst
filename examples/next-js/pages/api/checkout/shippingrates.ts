...
import { OrderCalculatePayload, withOCWebhookAuth } from "ordercloud-javascript-catalyst";
...
export default apiHandler({
  ...
  post: withOCWebhookAuth(shippingRatesHandler, process.env.OC_WEBHOOK_HASH_KEY)
});
